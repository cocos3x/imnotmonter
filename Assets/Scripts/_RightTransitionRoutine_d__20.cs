using UnityEngine;
private sealed class BoundariesAnimator.<RightTransitionRoutine>d__20 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    private float <initialRightBoundary>5__2;
    ...
    // Methods
    public BoundariesAnimator.<RightTransitionRoutine>d__20(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
        ...
        this.<>4__this.NumericBoundaries.UseRightBoundary = false;
        this.<>4__this.UseRightBoundary = false;
        goto label_30;
        label_5:
        if((this.<>4__this) != 0)
        {
        ...
        this.<initialRightBoundary>5__2 = 52;
        val_13 = this.<>4__this.NumericBoundaries;
        this.<>4__this.NumericBoundaries.TargetRightBoundary = this.<>4__this.RightBoundary;
        val_11 = 0f;
        this.<t>5__3 = 0f;
        label_11:
        ...
        val_14 = this.<initialRightBoundary>5__2;
        if((this.<>4__this.UseLeftBoundary) > false)
        {
            goto label_19;
        }
        ...
        label_18:
        float val_4 = Com.LuisPedroFonseca.ProCamera2D.Utils.EaseFromTo(start:  val_8, end:  val_1.y, value:  val_14, type:  this.<initialRightBoundary>5__2);
        this.<>4__this.NumericBoundaries.RightBoundary = this.<initialRightBoundary>5__2;
        ...
        label_19:
        this.<>4__this.NumericBoundaries.RightBoundary = this.<>4__this.Vector3H;
        label_27:
