using UnityEngine;
public class CameraPinPullController : SingletonMonoBehaviour<CameraPinPullController>
{
    // Fields
    ...
    public void MoveToCharacter(bool isWin)
    {
        ...
        UnityEngine.Transform val_9 = mem[3221266323].transform;
        ...
        UnityEngine.Transform val_14 = mem[3221266327].transform;
        ...
        if((UnityEngine.Object.op_Implicit(exists:  mem[3221266323])) != false)
        {
            ...
            UnityEngine.Transform val_22 = mem[3221266323].transform;
        ...
        DG.Tweening.Tweener val_31 = DG.Tweening.ShortcutExtensions.DOMove(target:  636937104, endValue:  new UnityEngine.Vector3() {x = val_37, y = val_38 + 0.5f, z = -10f}, duration:  0.5f, snapping:  false);
        DG.Tweening.Tweener val_32 = DG.Tweening.TweenSettingsExtensions.SetEase<DG.Tweening.Tweener>(t:  636937104, ease:  4);
    ...
    public void ResetPosCamera()
    {
        ...
        int val_2 = DG.Tweening.ShortcutExtensions.DOKill(target:  637061392, complete:  false);
    ...
    public CameraPinPullController()
    {
