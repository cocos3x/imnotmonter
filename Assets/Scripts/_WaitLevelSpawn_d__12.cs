using UnityEngine;
private sealed class LevelPinPullManager.<WaitLevelSpawn>d__12 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public LevelPinPullManager.<WaitLevelSpawn>d__12(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
        ...
        string val_21 = val_30 + 640657928;
        val_32 = 0;
        ...
        Weight val_26 = this.<>4__this + 48.GetComponent<Weight>();
        if((this.<>4__this + 48) != 0)
        {
                this.<>4__this.totalCoinOfLevel = this.<>4__this + 48 + 12;
            val_33 = mem[this.<>4__this + 48 + 16];
            val_33 = this.<>4__this + 48 + 16;
            this.<>4__this.totalStickBarrie = val_33;
        }
        else
        {
                this.<>4__this.totalCoinOfLevel = 0;
            this.<>4__this.totalStickBarrie = 2621443;
            val_33 = this.<>4__this.totalStickBarrie;
        }
        
        this.<>4__this.totalEnemy = this.<>4__this + 48 + 20;
        this.<>4__this.currentStickBarrie = val_33;
        if(val_33 < 1)
        {
                0 = 1;
        }
        
        this.<>4__this.currentEnemy = this.<>4__this + 48 + 20;
        this.<>4__this.allStickBarrieMove = true;
        if((this.<>4__this + 48 + 20) < 1)
        {
                0 = 1;
        }
        
        this.<>4__this.allEnemyDead = true;
        this.<>4__this.charBase = this.<>4__this + 48 + 24;
        this.<>4__this.huggyControl = this.<>4__this + 48 + 28;
        this.<>4__this.StopCoroutine(methodName:  -1610602601);
        this.<>4__this.StopCoroutine(methodName:  -1610602613);
