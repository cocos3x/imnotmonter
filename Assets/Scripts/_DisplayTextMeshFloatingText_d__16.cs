using UnityEngine;
private sealed class TextMeshProFloatingText.<DisplayTextMeshFloatingText>d__16 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public TextMeshProFloatingText.<DisplayTextMeshFloatingText>d__16(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
        ...
        System.Collections.IEnumerator val_5 = this.<>4__this.DisplayTextMeshFloatingText();
            ...
            if(((mem[536895462] & true) == 0) && (mem[536895391] == 0))
        {
            ...
            var val_8 = (mem[536895367] + 4) + ((UnityEngine.Random.Range(minInclusive:  0, maxExclusive:  20)) << 2);
        ...
        this.<>4__this.m_textMesh.text = 961691492;
        if((this.<>4__this.m_textMesh) < 0)
        {
                (uint)this.<alpha>5__7 = (int)this.<alpha>5__7;
        }
        
        UnityEngine.Color32 val_13 = new UnityEngine.Color32(r:  this.<start_color>5__6, g:  0, b:  0, a:  (int)((uint)this.<alpha>5__7) & 255);
        UnityEngine.Color val_14 = UnityEngine.Color32.op_Implicit(c:  new UnityEngine.Color32() {r = 84, g = 63, b = 82, a = 57});
        this.<>4__this.m_textMesh.color = new UnityEngine.Color() {r = val_15, g = val_16, b = val_17, a = val_18};
        ...
        val_39 = this.<>4__this.lastRotation;
        UnityEngine.Quaternion val_26 = rotation;
        if((TMPro.TMPro_ExtensionMethods.Compare(q1:  new UnityEngine.Quaternion() {x = val_39, y = mem[(this.<>4__this + 56) + (0)], z = mem[(this.<>4__this + 56) + (4)], w = mem[(this.<>4__this + 56) + (8)]}, q2:  new UnityEngine.Quaternion(), accuracy:  1000)) == true)
        {
            goto label_26;
        }
