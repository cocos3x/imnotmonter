using UnityEngine;
private sealed class BoundariesAnimator.<LeftTransitionRoutine>d__19 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    private float <initialLeftBoundary>5__2;
    ...
    // Methods
    public BoundariesAnimator.<LeftTransitionRoutine>d__19(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
        ...
        this.<>4__this.NumericBoundaries.UseLeftBoundary = false;
        this.<>4__this.UseLeftBoundary = false;
        goto label_30;
        label_5:
        if((this.<>4__this) != 0)
        {
        ...
        this.<initialLeftBoundary>5__2 = 52;
        val_13 = this.<>4__this.NumericBoundaries;
        this.<>4__this.NumericBoundaries.TargetLeftBoundary = this.<>4__this.LeftBoundary;
        val_11 = 0f;
        this.<t>5__3 = 0f;
        label_11:
        ...
        val_14 = this.<initialLeftBoundary>5__2;
        if((this.<>4__this.UseRightBoundary) < 0)
        {
            goto label_19;
        }
        
        label_18:
        float val_4 = Com.LuisPedroFonseca.ProCamera2D.Utils.EaseFromTo(start:  val_8, end:  val_1.y, value:  val_14, type:  this.<initialLeftBoundary>5__2);
        this.<>4__this.NumericBoundaries.LeftBoundary = this.<initialLeftBoundary>5__2;
        UnityEngine.Vector3 val_5 = LocalPosition;
        val_10 = val_2;
        float val_6 = this.<>4__this.Vector3H.Invoke(arg:  new UnityEngine.Vector3() {x = R6, y = SB, z = val_10});
        ...
        label_19:
        this.<>4__this.NumericBoundaries.LeftBoundary = this.<>4__this.Vector3H;
        label_27:
