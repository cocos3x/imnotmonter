using UnityEngine;
private sealed class WinPopup.<>c__DisplayClass69_1
{
    // Fields
    public UnityEngine.GameObject coin;
    public WinPopup.<>c__DisplayClass69_0 CS$<>8__locals1;
    public DG.Tweening.TweenCallback <>9__1;
    
    // Methods
    public WinPopup.<>c__DisplayClass69_1()
    {
    
    }
    internal void <CoinMovesX2>b__0()
    {
        ...
        {
                val_7 = 536895905;
            val_7 = new DG.Tweening.TweenCallback(object:  788326800, method:  new IntPtr(1610681479));
            this.<>9__1 = val_7;
        }
    ...
    internal void <CoinMovesX2>b__1()
    {
