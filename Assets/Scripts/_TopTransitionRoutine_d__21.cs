using UnityEngine;
private sealed class BoundariesAnimator.<TopTransitionRoutine>d__21 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    private float <initialTopBoundary>5__2;
    ...
    // Methods
    public BoundariesAnimator.<TopTransitionRoutine>d__21(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
        ...
        this.<>4__this.UseTopBoundary = false;
        goto label_30;
        label_5:
        if((this.<>4__this) != 0)
        {
        ...
        this.<initialTopBoundary>5__2 = 256;
        val_13 = this.<>4__this.NumericBoundaries;
        this.<>4__this.NumericBoundaries.TargetTopBoundary = this.<>4__this.TopBoundary;
        val_11 = 0f;
        this.<t>5__3 = 0f;
        label_11:
        ...
        val_14 = this.<initialTopBoundary>5__2;
        if((this.<>4__this.UseBottomBoundary) > false)
        {
            goto label_19;
        }
        ...
        label_18:
        float val_4 = Com.LuisPedroFonseca.ProCamera2D.Utils.EaseFromTo(start:  val_8, end:  val_1.y, value:  val_14, type:  this.<initialTopBoundary>5__2);
        this.<>4__this.NumericBoundaries.TopBoundary = this.<initialTopBoundary>5__2;
        ...
        label_19:
        this.<>4__this.NumericBoundaries.TopBoundary = this.<>4__this.Vector3V;
        label_27:
