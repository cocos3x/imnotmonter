using UnityEngine;
private sealed class BaseTrigger.<TestTriggerRoutine>d__19 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    private int <>1__state;
    private object <>2__current;
    public Com.LuisPedroFonseca.ProCamera2D.BaseTrigger <>4__this;
    ...
    // Methods
    public BaseTrigger.<TestTriggerRoutine>d__19(int <>1__state)
    {
