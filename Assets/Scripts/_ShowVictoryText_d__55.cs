using UnityEngine;
private sealed class WinPopup.<ShowVictoryText>d__55 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public WinPopup.<ShowVictoryText>d__55(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
            ...
            if((this.<>1__state) != 0)
        {
            ...
            this.<>1__state = 0;
            536875159 = new System.Func<System.Boolean>(object:  this.<>4__this, method:  new IntPtr(1610681393));
        ...
        536882991 = new System.Action(object:  this.<>4__this, method:  new IntPtr(1610681395));
