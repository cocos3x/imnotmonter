using UnityEngine;
private sealed class SetAnimationPlayer.<DelayShowAnimWin>d__21 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public SetAnimationPlayer.<DelayShowAnimWin>d__21(int <>1__state)
    {
