using UnityEngine;
private sealed class WebMessager.<Send>d__18 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public WebMessager.<Send>d__18(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
            ...
            if((this.<>1__state) != 0)
        {
            ...
            val_1 = new UnityEngine.WWW(url:  this.aTo, postData:  this.aData);
            this.<www>5__2 = val_1;
